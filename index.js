...
/////////////////
const BotName = '🐵RANZ BOT🐵'; 
const instagram = 'https://instagram.com/hh.ranz'; 
const telegram = 'belum ada'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@hh.ranz')
